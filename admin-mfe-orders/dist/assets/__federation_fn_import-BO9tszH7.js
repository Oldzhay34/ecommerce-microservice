...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-CBegDaUF.js', import.meta.url).href),import:true,requiredVersion:'18.3.1'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-DFP2NIW6.js', import.meta.url).href),import:true,requiredVersion:'18.3.1'},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-BESTcHRN.js', import.meta.url).href),import:true,requiredVersion:'5.51.1'}};
