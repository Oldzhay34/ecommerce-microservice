import { i as importShared } from './_virtual___federation_fn_import-BdFURzqk.js';
...
const TokenCatcher = () => {
  ...
  if (!hasToken && !authToken) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-canvas gap-5 px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xl font-bold tracking-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-ink-primary", children: "Shop" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand", children: "Bridge" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-ink-secondary max-w-sm", children: "Yönetim paneline devam etmek için oturum açmanız gerekiyor." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-canvas", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-4 border-brand/30 border-t-brand rounded-full animate-spin" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-ink-secondary font-medium", children: "Yönetici oturumu doğrulanıyor..." })
  ] });
};
...
'admin_mfe_orders':{url:'http://localhost:6101/assets/remoteEntry.js',format:'esm',from:'vite'},
  ...
  'admin_mfe_reviews':{url:'http://localhost:6103/assets/remoteEntry.js',format:'esm',from:'vite'}
                ...
                const wrapShareModule = remoteFrom => {
                    return {
                        'react':{'18.3.1':{get:()=>get(new URL('__federation_shared_react-CBegDaUF.js', import.meta.url).href, remoteFrom), loaded:1}},'react-dom':{'18.3.1':{get:()=>get(new URL('__federation_shared_react-dom-DFP2NIW6.js', import.meta.url).href, remoteFrom), loaded:1}},'@tanstack/react-query':{'5.101.2':{get:()=>get(new URL('__federation_shared_@tanstack/react-query-Dmk52it9.js', import.meta.url).href, remoteFrom), loaded:1}},'zustand':{'4.5.7':{get:()=>get(new URL('__federation_shared_zustand-B45j4_a8.js', import.meta.url).href, remoteFrom), loaded:1}}
                    }
                };
...
const TopBar = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 h-[72px] w-full bg-canvas/90 backdrop-blur-xl shadow-[0_1px_0_rgba(15,15,15,0.06)] px-6 md:px-8 flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xl font-extrabold tracking-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-ink-primary", children: "Shop" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand", children: "Bridge" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-ink-secondary font-semibold uppercase tracking-wider bg-surface-hover px-2.5 py-1 rounded-full", children: "Yönetim Paneli" })
    ] }),
...
const TabBar = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full border-b border-line-card flex items-center space-x-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => onTabChange("orders"),
        className: `h-11 px-5 text-sm font-semibold border-b-2 transition-all flex items-center ${activeTab === "orders" ? "text-brand border-brand" : "text-ink-secondary border-transparent hover:text-ink-primary"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Siparişler" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `ml-2 px-2 py-0.5 text-xs font-semibold rounded-full ${activeTab === "orders" ? "bg-brand-soft text-brand" : "bg-surface text-ink-secondary"}`, children: orderCountNode })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: `h-11 px-5 text-sm font-semibold border-b-2 transition-all flex items-center ${activeTab === "payments" ? "text-brand border-brand" : "text-ink-secondary border-transparent hover:text-ink-primary"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Ödemeler" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `ml-2 px-2 py-0.5 text-xs font-semibold rounded-full ${activeTab === "payments" ? "bg-brand-soft text-brand" : "bg-surface text-ink-secondary"}`, children: refundCountNode })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: `h-11 px-5 text-sm font-semibold border-b-2 transition-all flex items-center ${activeTab === "reviews" ? "text-brand border-brand" : "text-ink-secondary border-transparent hover:text-ink-primary"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Yorumlar" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `ml-2 px-2 py-0.5 text-xs font-semibold rounded-full ${activeTab === "reviews" ? "bg-brand-soft text-brand" : "bg-surface text-ink-secondary"}`, children: reviewCountNode })
        ]
      }
    )
  ] });
...
class RemoteErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border border-danger/30 bg-danger-soft rounded-sb-lg text-danger", children: [
...
const AdminDashboardPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-canvas flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-[1280px] w-full mx-auto px-6 md:px-8 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-semibold tracking-tight text-ink-primary", children: "Yönetim Paneli" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-ink-secondary mt-2", children: "Siparişleri, ödemeleri ve yorumları buradan yönetin." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5 mb-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 bg-surface rounded-sb-lg p-6 md:p-8 shadow-sb", children: [
