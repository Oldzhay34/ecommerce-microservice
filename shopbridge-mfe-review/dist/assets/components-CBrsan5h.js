...
const Card = ({ children, className = "" }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `bg-surface border border-border rounded-sb-lg shadow-sb p-4 ${className}`, children });
const ErrorBanner = ({ message }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-danger/10 text-danger border-l-4 border-danger rounded-r-sb", children: message });
const Skeleton = ({ height = "h-32" }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-full ${height} bg-surface animate-pulse rounded-sb-lg` });

export { Card as C, ErrorBanner as E, Skeleton as S, axios as a };
