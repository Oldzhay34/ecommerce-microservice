...
const Card = ({ children, className = "" }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `bg-white border rounded-lg shadow-sm p-4 ${className}`, children });
const ErrorBanner = ({ message }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-red-50 text-red-700 border-l-4 border-red-500 rounded-r", children: message });
const Skeleton = ({ height = "h-32" }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-full ${height} bg-gray-200 animate-pulse rounded-lg` });
