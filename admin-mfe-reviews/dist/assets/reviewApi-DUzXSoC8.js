...
const makeReviewApi = (client) => {
  return {
    getReviews: async () => {
      const response = await client.get(`${ENDPOINTS.reviews}/all`);
      return response.data;
    },
    moderateReview: async (id, status) => {
      await client.patch(`${ENDPOINTS.reviews}/${id}/moderate`, { status });
    }
  };
};

export { AuthTokenProvider as A, createApiClient as c, makeReviewApi as m, useAuthToken as u };
