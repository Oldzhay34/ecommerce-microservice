...
export default defineConfig({
  plugins: [
    ...
    (federation as any)({
      ...
      exposes: {
        './StoreReviews': './src/expose/StoreReviews.tsx',
      },
      shared: {
  ...
  server: { port: 6004, cors: { origin: ['http://localhost:3000', 'http://localhost:3001'] } },
  preview: { port: 6004, cors: { origin: ['http://localhost:3000', 'http://localhost:3001'] } },
});