...
--
-- NOT: statement separator cift noktali virgul olarak ayarlandi (spring.sql.init.separator, bkz.
-- application.yaml) - Spring'in varsayilan ScriptUtils satir ayirici tek ';' karakteri
-- kullanir ve Postgres'in $$ dolar-quote fonksiyon govdesi icindeki (RAISE EXCEPTION
-- mesaji gibi) sıradan ';' karakterlerini de YANLISLIKLA ayirici sanip script'i
-- ortadan bolup gecersiz SQL uretiyordu. Fonksiyon/trigger govdesi icindeki TEK ';'
