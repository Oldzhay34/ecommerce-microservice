...
export default defineConfig({
  plugins: [
    ...
    (federation as any)({
      ...
      exposes: {
        './StoreOrders': './src/expose/StoreOrders.tsx',
        './StoreOrderMetrics': './src/expose/StoreOrderMetrics.tsx',
      },
      shared: {
  ...
  server: { port: 6001, cors: { origin: ['http://localhost:3000', 'http://localhost:3001'] } },
  preview: { port: 6001, cors: { origin: ['http://localhost:3000', 'http://localhost:3001'] } },
});