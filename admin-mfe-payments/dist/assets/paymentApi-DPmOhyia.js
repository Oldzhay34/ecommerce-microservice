...
const makePaymentApi = (client) => {
  return {
    ...
    approveRefund: async (id) => {
      await client.patch(`${ENDPOINTS.payments}/${id}/refund-approve`);
    }
  };
};

export { AuthTokenProvider as A, createApiClient as c, makePaymentApi as m, useAuthToken as u };
