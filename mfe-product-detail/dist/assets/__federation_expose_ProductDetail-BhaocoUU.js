...
const remotesMap = {
'mfe_media_gallery':{url:'http://localhost:6008/assets/remoteEntry.js',format:'esm',from:'vite'},
  'mfe_reviews':{url:'http://localhost:5004/assets/remoteEntry.js',format:'esm',from:'vite'}
};
...
const {createContext,useMemo: useMemo$3} = await importShared('react');

const AuthTokenContext = createContext(null);
function AuthTokenProvider({ token, children }) {
  const value = useMemo$3(() => ({ token }), [token]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthTokenContext.Provider, { value, children });
}
...
const PRODUCT_BY_ID = (id) => `/api/v1/products/${encodeURIComponent(id)}`;
...
function isApiErrorResponse(value) {
  ...
  return typeof candidate.message === "string" && typeof candidate.status === "number" && typeof candidate.timestamp === "string" && typeof candidate.path === "string";
}
...
const {useContext,useMemo: useMemo$2} = await importShared('react');
...
function useApiClient() {
  ...
  return useMemo$2(() => createApiClient(() => token), [token]);
}

function makeProductApi(client) {
  return {
    async getProductById(id) {
      const response = await client.get(PRODUCT_BY_ID(id));
...
const productDetailQueryKey = (productId) => ["product-detail", productId];
function useProductDetail(productId) {
  const client = useApiClient();
  const productApi = useMemo$1(() => makeProductApi(client), [client]);
  return useQuery({
...
function useAddToCart({
  ...
  return useMutation({
    mutationFn: (request) => cartApi.addItem(request),
    onSuccess: () => {
...
function StockBadge({ stock }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 13, color: "#6B7280" }, children: view.note })
  ] });
}
...
function QuantityStepper({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "#111827" }, children: "Adet" }),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: decrementDisabled ? void 0 : "hover:bg-[#F9FAFB]",
              style: {
                ...buttonBaseStyle,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: isOutOfStock ? MIN_QUANTITY : quantity
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => onChange(quantity + 1),
              className: incrementDisabled ? void 0 : "hover:bg-[#F9FAFB]",
              style: {
                ...buttonBaseStyle,
...
function AddToCartButton({ stock, isPending, onClick }) {
  const isOutOfStock = stock <= 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      disabled,
      onClick,
      className: disabled ? void 0 : "hover:bg-[#1E40AF]",
      style: {
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
      ...
      children: [
        isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}) : null,
...
function ProductInfoPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 32, fontWeight: 700, color: "#111827" }, children: formatTRY(product.price) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 16 } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StockBadge, { stock: product.stock }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 24 } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 1, backgroundColor: "#E5E7EB", width: "100%" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 24 } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      QuantityStepper,
      {
    ...
    errorSlot ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 16 }, children: errorSlot }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 24, display: "flex", alignItems: "center", gap: 8 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          style: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: blocks.map((block, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "sb-shimmer",
            style: {
...
function ProductNotFound({ onBack }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "48px 24px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 16, fontWeight: 600, color: "#111827" }, children: "Ürün bulunamadı." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14, color: "#6B7280", marginTop: 8 }, children: "Aradığınız ürün kaldırılmış veya adresi değişmiş olabilir." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 20 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: onBack,
...
function ErrorBanner({ message, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    children ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 12 }, children }) : null
  ] });
}
...
const {useCallback,useEffect,useState,Suspense,lazy} = await importShared('react');
const RemoteProductGallery = lazy(() => __federation_method_getRemote("mfe_media_gallery" , "./ProductGallery").then(module=>__federation_method_wrapDefault(module, true)));
const ProductReviews = lazy(() => __federation_method_getRemote("mfe_reviews" , "./ProductReviews").then(module=>__federation_method_wrapDefault(module, true)));
const GalleryFallback = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "div",
  {
...
const ReviewsFallback = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "div",
  {
    className: "animate-pulse",
...
function ProductDetail({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthTokenProvider, { token: session.authToken, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductDetailContent, { productId, onNavigate }) });
}
function ProductDetailContent({ productId, onNavigate }) {
  ...
  const handleAddToCart = useCallback(() => {
    mutation.mutate({ productId, quantity: clampQuantity(quantity, stock) });
  }, [mutation, productId, quantity, stock]);
  const backLink = /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      onClick: handleBack,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: "100%" }, children: [
    ...
    backLink,
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 20 } }),
    query.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: cardStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DetailSkeleton, {}) }) : null,
    !query.isPending && query.isError && isNotFound(query.error) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: cardStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductNotFound, { onBack: handleBack }) }) : null,
    !query.isPending && query.isError && !isNotFound(query.error) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: cardStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBanner, { message: query.error.message, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => {
    ...
    !query.isPending && !query.isError && product === null ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: cardStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductNotFound, { onBack: handleBack }) }) : null,
    !query.isPending && !query.isError && product !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: cardStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sb-detail-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(RemoteProductGallery, { productId: product.id }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ProductInfoPanel,
          {
            product,
            ...
            errorSlot: mutation.isError ? /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBanner, { message: mutation.error.message }) : null
          }
        )
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewsFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductReviews, { productId: product.id }) })
    ] }) : null,
    toastVisible ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      Toast,
      {
