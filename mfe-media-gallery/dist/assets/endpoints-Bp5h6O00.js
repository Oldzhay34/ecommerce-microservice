...
const MEDIA_ENDPOINTS = {
  ...
  productImages: (productId) => `/api/v1/media/products/${productId}/images`,
  // POST -> ROLE_STORE, multipart/form-data, field adı: "file", tek dosya
  uploadImage: (productId) => `/api/v1/media/products/${productId}/images`
};
const MEDIA_LIMITS = {
...
export { ApiError as A, MEDIA_LIMITS as M, createApiClient as c, fetchProductMedia as f, makeMediaApi as m };
