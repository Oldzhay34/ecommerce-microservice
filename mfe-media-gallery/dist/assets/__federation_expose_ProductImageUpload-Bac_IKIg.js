    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        className: [
          ...
          "transition-colors",
          blocked ? "border-line bg-canvas cursor-not-allowed opacity-60" : "cursor-pointer hover:border-brand",
        ...
        children: [
          ...
          !isFull && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted text-xs mt-1.5", children: [
...
function StatusLine({
  ...
  if (!result || result.status === "pending") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-faint text-xs mt-0.5", children: formatBytes(sizeBytes) });
  }
  if (result.status === "uploading") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-xs mt-0.5", children: "Yükleniyor…" });
  }
  if (result.status === "success") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5 text-green-600", children: "Yüklendi" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-err-tx text-xs mt-0.5", children: result.message });
}
...
function ProductImageUploader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    images.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-xs mt-3", children: "İlk sıradaki görsel ürünün kapak görseli olur. Sıralamayı ↑ ile değiştirebilirsiniz." })
  ] });
}
