  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] text-ink-faint text-center px-4", children: "Görsel yakında eklenecek" })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 overflow-x-auto pb-2 mt-4 custom-scrollbar", children: assets.map((asset) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        className: `w-[72px] h-[72px] rounded-sb-lg overflow-hidden shrink-0 cursor-pointer transition-colors border ${isActive ? "border-[2px] border-brand" : "border border-border hover:border-border-strong"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: asset.thumbUrl,
